...
- **7 pages don't apply** — all licensing/activation, since OpenMultiSeat has no license system of any kind (see [`../user-manual/licensing-model.md`](../user-manual/licensing-model.md))
